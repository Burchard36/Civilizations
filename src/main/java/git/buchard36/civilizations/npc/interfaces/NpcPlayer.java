...
public class NpcPlayer extends EntityHumanNPC {

    protected final MoveController controller;

    public NpcPlayer(MinecraftServer minecraftServer, ServerLevel world, GameProfile gameProfile, ProfilePublicKey ppk, NPC npc) {
        super(minecraftServer, world, gameProfile, ppk, npc);
        this.controller = new MoveController(this);
    }
    ...
    protected static class MoveController extends PlayerMoveControl {
        ...
        public MoveController(LivingEntity entityinsentient) {
